...
class Character(pg.sprite.Sprite):
    ...
    def is_on_trampoline(self, trampoline):
        return (
            self.rect.right < trampoline.rect.right
            and self.rect.right > trampoline.rect.left
            or self.rect.left >= trampoline.rect.left
            and self.rect.left <= trampoline.rect.right
        ) and self.rect.bottom > 600
    ...
    def move(self, moving_left, moving_right):
        ...
        if self.rect.bottom + dy > HEIGHT - 10:
            ...
            self.rect.bottom + dy > HEIGHT - 200
            and self.rect.left < 800
            and self.rect.right > 600
        ):
