...
class BaseEntity:
    ...
    def __init__(
        ...
        self.created_at = pygame.time.get_ticks()  # get the time in milliseconds
    ...
    def update(self, events: Sequence[GameEvent], world: World):
        ...
        if self.ttl_ms is not None:
            if pygame.time.get_ticks() - self.created_at > self.ttl_ms:
    ...
    def set_remaining_ttl_ms(self, remaining_ttl_ms: int):
        ...
        """
        self.ttl_ms = remaining_ttl_ms + pygame.time.get_ticks() - self.created_at
